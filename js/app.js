...
<div class="container" style="padding-top: ${UI.header_padding}px;${UI.fixed_footer ?' padding-bottom: clamp(170px, 100%, 300px);': ''}">
    <div class="col-md-12" style="margin-bottom: 0rem; margin-top: 2rem;">
        <div style="padding:0px 30px;background:#BE1E2D;border-radius:0.25rem;width:auto;overflow:hidden;">
