...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Donasi</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item"  href=" ${UI.project1_link}" target="_blank"> ${UI.project1_name}</a><a class="dropdown-item"  href=" ${UI.project2_link}" target="_blank"> ${UI.project2_name}</a>`;
